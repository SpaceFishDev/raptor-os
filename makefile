...
run:
	qemu-system-x86_64 -m 1G -cpu qemu64  -drive file=disk.img,if=floppy,index=1,format=raw -drive file=build/kernel.img,if=floppy,index=0,format=raw
